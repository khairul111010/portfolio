...
const Navbar = () => {
  return (
    <header
      className={`sticky top-5 backdrop-blur-md flex items-center justify-between rounded-2xl border border-[#cecece] w-[960px] left-[calc(50%-960px/2)] z-10 px-5 py-5 ${jetBrains.className}`}
    >
